...
Flujo diagnóstico semiautomático: ejecutar preflight, seleccionar agente/modelo, crear paquete de handoff, registrar resultado inicial y mostrar trazabilidad visible sin modificar documentación funcional.
