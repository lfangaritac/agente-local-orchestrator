...
Flujo diagnóstico semiautomático: ejecutar preflight, seleccionar agente/modelo, crear paquete de handoff, registrar resultado inicial y mostrar trazabilidad visible sin invocar modelos ni modificar documentación funcional.
