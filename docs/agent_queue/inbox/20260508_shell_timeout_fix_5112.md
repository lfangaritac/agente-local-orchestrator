...
3. Identificar causa probable: payload grande, stdout excesivo, proceso hijo sin cierre, timeout fijo insuficiente, respuesta MCP pesada, alias inconsistente o parsing lento.
4. Implementar mitigaciones acotadas: respuestas compactas, límites de preview, campos resumidos, timeouts razonables o instrumentación elapsed_ms/stdout_bytes si aplica.
