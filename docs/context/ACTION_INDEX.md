...
| ACT-0020 | 2026-05-26 | ops_tooling | Semantic Context Gate fijo antes de diagnosticar/editar | done | orchestrator | Build | `docs/protocols/SEMANTIC_CONTEXT_GATE_PROTOCOL.md`; `scripts/semantic_context_gate.py`; `mcp_server/tools.py`; `mcp_server/schemas.py`; `CONTINUE_USAGE_PROTOCOL.md` | Busca contexto por senales inferidas de la instruccion; compacto, read-only y no limitado a lista fija de temas |
| ACT-0021 | 2026-05-26 | ops_tooling | Project Context Indexer + Semantic Tag Index | done | orchestrator | Build | `scripts/project_context_indexer.py`; `docs/projects/<project-id>/SEMANTIC_TAG_INDEX.md`; `scripts/semantic_context_gate.py`; `mcp_server/tools.py`; `mcp_server/schemas.py` | El conocimiento semantico vive en docs versionados por proyecto; el gate consulta tags antes de busqueda libre |
